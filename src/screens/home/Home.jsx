          ...
          <div className="home-heading">
            ...
            <div className="home-heading-right">
              <div id="home-heading-text">
                ...
                <p>
                  Break has your applications and requirements all in one place
            ...
            <div className="home-categories-left">
              <div className="categories-container">
                ...
                <div className="categories-row">
                  ...
                  <div className="categories-column">
                    ...
                    {selectedOp === "dr" && (
                      <>
                        <section>
                          <input type="radio" name="field" value="pharmd" />
                        ...
                        <section>
                          <input type="radio" name="field" value="jd" />
                ...
                <button id="submit-field">
                  {(selectedOp === null || selectedField === null) && (
                    <p id="error-popup" onClick={showPopup}>Help me get in!</p>
                  )}
                  {(selectedOp === "dr" && selectedField === "md") && (
                    <Link to="/tracker/dr/md">Help me get in!</Link>
                  )}
                </button>
              </div>
            </div>
            {/* TO DO: add pop up for fields not finished */}
            <div className="home-categories-right"></div>
          </div>
        </div>
        <Footer />
      </div>
